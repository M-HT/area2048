...
void	TSKenemy08(int id)
{
	...
	switch(TskBuf[id].step){
		case	0:
			...
			TskBuf[id].fp_exit = &TSKenemy08Exit;
		...
		case	1:
			...
			if(!TskBuf[id].wait){
				...
				TskBuf[id].fp_int = &TSKenemy08Int;
		...
		case	2:
			...
			if(TskBuf[id].py < ship_py){
				if(TskBuf[id].vy > +0.0f) TskBuf[id].vy += 1.0f / SPEED_RATE * 3.0f;
				else					  TskBuf[id].vy += 1.0f / SPEED_RATE * 1.0f;
